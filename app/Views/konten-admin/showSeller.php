            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" name="" value="<?= $seller->name ?>" class="form-control">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9 form-inline">
                            <div class="input-radio">
                                <label>
                                    <input type="radio" name="sex" id="input" value="male" <?= $seller->sex == 'male' ? 'checked' : '' ?>>
                                    Male
                                </label>
                                <label>
                                    <input type="radio" name="sex" id="input" value="female" <?= $seller->sex == 'female' ? 'checked' : '' ?>>
                                    Female
                                </label>
                            </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-9">
                            <input class="form-control" type="email" name="" autocomplete="off" value="<?= $seller->email ?>">
                            <span class="text-danger"><i>Required Field</i></span>
                        </div>
                    </div>
                    <div class="row form-group">
